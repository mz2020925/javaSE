...
public class j1_LocalDateTime {
    public static void main(String[] args) {
        // LocalDateTime没有构造方法，通过下面的静态方法获取对象
        ...
        // public static LocalDateTime of(int year, int month, int dayOfMonth, int hour, int minute, int second)，以给定额年月日时分秒获取LocalDateTime对象
